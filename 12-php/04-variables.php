        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                ...
                <?php 
                    ...
                    $alert4   = 'alert alert-info alert-dismissible fade show text-start';
					$user1    = 1;
					$user2    = 2;
					$user3    = 3;
                    $user4    = 4;
                ...
                <div class="<?php echo $alert4; ?>"> 
					<strong>User <?php echo $user4; ?>: the information is not registered</strong>
